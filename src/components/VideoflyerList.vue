  ...
  <v-card>
    ...
    >
            ...
            <v-card>
              ...
              <v-card-text>
                <v-form ref="form" v-model="valid">
                  <EditVideoflyer
                    :videoflyer="editedItem"
                    @update-videoflyer="editedItem = $event"
                  />
                </v-form>
              </v-card-text>
      ...
      <template #[`item.actions`]="{ item }">
        <v-icon size="small" class="mr-2" @click="editVideoflyer(item)">
          mdi-pencil
        </v-icon>
        <v-icon size="small" class="mr-2" @click="deleteItem(item)">
          mdi-delete
        </v-icon>
        <v-icon size="small" @click="assignVideoflyer(item)">
          mdi-calendar-month
        </v-icon>
